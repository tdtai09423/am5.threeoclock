export default function InfoCard() {
  return (
    <div className="bg-[#eac4a2] p-0 rounded-[70px] max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row gap-6 items-center p-0">
        ...
        <div className="flex-1 space-y-4 text-2xl p-10">
          <p className="text-gray-800 leading-relaxed">
            ...
            <span className="font-semibold">QUY ÂM 5</span> sẽ có thêm sức mạnh
            giúp đỡ cho nhiều em nhỏ hơn nữa.
          </p>
